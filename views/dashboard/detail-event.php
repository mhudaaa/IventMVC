                            ...
                            <div class="row">
                                <div class="col s5 grey-text text-lighten-1">
                                    ...
                                    <div class="row lihat-peserta">
                                        <div class="col s10">
                                            <a href="<?=base_url?>dashboard/peserta/<?=$detailEvent->id_event?>"><button class="hvr-shrink btn-border btn-block">Lihat peserta</button></a>
                                        </div>
                                    </div>
                                </div>
                                <div class="col s7 grey-text text-darken-5">
                                    ...
                                    <ul class="event-info grey-text text-lighten-1">
                                        <li><i class="lnr lnr-calendar-full"></i> <?=date('d M Y', strtotime($detailEvent->tgl_event));?></li>
